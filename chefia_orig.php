                ...
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="chefia.html">Chefia</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="laboratorios.html">Laboratórios de Pesquisa</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="docentes.html">Docentes</a></li>
            ...
            <div class="timeline">
                <div class="timeline-item current">
                    ...
                    <div class="timeline-content">
                        ...
                        <div class="timeline-name">Wilson Araújo da Silva Júnior</div>
                        <div class="timeline-role">Chefe do Departamento de Genética</div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-content">
                        ...
                        <div class="timeline-name">A definir</div>
                        <div class="timeline-role">Chefe do Departamento de Genética</div>
                    </div>
                </div>
                ...
                <div class="timeline-item">
                    <div class="timeline-dot"></div>
                    <div class="timeline-content">
                        <div class="timeline-year">2000 – 2004</div>
                        <div class="timeline-name">A definir</div>
                        <div class="timeline-role">Chefe do Departamento de Genética</div>
                    </div>
                </div>
                ...
                <div class="timeline-item">
                    <div class="timeline-dot"></div>
                    <div class="timeline-content">
                        <div class="timeline-year">1996 – 2000</div>
                        <div class="timeline-name">A definir</div>
                        <div class="timeline-role">Chefe do Departamento de Genética</div>
                    </div>
                </div>
                ...
                <div class="timeline-item">
                    <div class="timeline-dot"></div>
                    <div class="timeline-content">
                        <div class="timeline-year">1992 – 1996</div>
                        <div class="timeline-name">A definir</div>
                        <div class="timeline-role">Chefe do Departamento de Genética</div>
                    </div>
                </div>
                ...
                <div class="timeline-item">
                    <div class="timeline-dot"></div>
                    <div class="timeline-content">
                        <div class="timeline-year">1984 – 1988</div>
                        <div class="timeline-name">A definir</div>
                        <div class="timeline-role">Chefe do Departamento de Genética</div>
                    </div>
                </div>
                ...
                <div class="timeline-item">
                    <div class="timeline-dot"></div>
                    <div class="timeline-content">
                        <div class="timeline-year">1980 – 1984</div>
                        <div class="timeline-name">A definir</div>
                        <div class="timeline-role">Chefe do Departamento de Genética</div>
                    </div>
                </div>
                ...
                <div class="timeline-item">
                    <div class="timeline-dot"></div>
                    <div class="timeline-content">
                        <div class="timeline-year">1976 – 1980</div>
                        <div class="timeline-name">A definir</div>
                        <div class="timeline-role">Chefe do Departamento de Genética</div>
                    </div>
                </div>
                ...
                <div class="timeline-item">
                    <div class="timeline-dot"></div>
                    <div class="timeline-content">
                        <div class="timeline-year">1972 – 1976</div>
                        <div class="timeline-name">A definir</div>
                        <div class="timeline-role">Chefe do Departamento de Genética</div>
                    </div>
                </div>
                ...
                <div class="timeline-item">
                    <div class="timeline-dot"></div>
                    <div class="timeline-content">
                        <div class="timeline-year">1968 – 1972</div>
                        <div class="timeline-name">A definir</div>
                        <div class="timeline-role">Chefe do Departamento de Genética</div>
                    </div>
                </div>
                ...
                <div class="timeline-item">
                    <div class="timeline-dot"></div>
                    <div class="timeline-content">
                        <div class="timeline-year">1965 – 1968</div>
                        <div class="timeline-name">Prof. Dr. Warwick Estevam Kerr</div>
                        <div class="timeline-role">Primeiro Chefe do Departamento de Genética</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-6 col-lg-2 offset-lg-1">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="docentes.html">Equipe</a></li>
