...
INSERT INTO `funcionarios` (`id`, `nome`, `funcao`, `setor`, `telefone`, `email`, `foto`, `categoria`) VALUES
...
UPDATE funcionarios SET nome   = CONVERT(BINARY CONVERT(nome   USING latin1) USING utf8mb4);
UPDATE funcionarios SET funcao = CONVERT(BINARY CONVERT(funcao USING latin1) USING utf8mb4);
UPDATE funcionarios SET setor  = CONVERT(BINARY CONVERT(setor  USING latin1) USING utf8mb4);
