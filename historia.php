...
<head>
    ...
    <title>História – Departamento de Genética – FMRP/USP</title>
            ...
            <div class="row g-4">
              ...
              class="docente-foto-borda"></div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="founder-card">
                        <div class="founder-avatar"><img 
              src="assets/img/fotos_antigas/lionel.jpg" 
              alt="Kerr"
              class="docente-foto-borda"></div>
                        <h5 class="founder-name">Prof. Dr. Lionel Segui Gonçalves</h5>
                        <div class="founder-role">Discípulo e Sucessor</div>
    ...
    <section class="numbers-section">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="number-card">
                        <span class="number-value">1A</span>
                        <span class="number-label">Conceito Capes</span>
                    </div>
                </div>
            </div>
        </div>
